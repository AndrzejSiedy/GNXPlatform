...
var loc = "http://localhost:8088/containers/commoncontainer/";
var host = "http://localhost:8088/";

var urlBase = loc.substr(0, loc.indexOf('/containers/commoncontainer/'));
console.warn('urlBase', urlBase);
var contextRoot = "http://localhost:8088/gadgets/js";
console.warn('contextRoot', contextRoot);
